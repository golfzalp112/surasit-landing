          ...
          <AnimateIn animation="fadeUp">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button
                onClick={async () => {
                  const shareData = {
                    title: 'สุรสิทธิ์ นิธิวุฒิวรรักษ์ | ผู้สมัคร สส. ชลบุรี เขต 6',
                    text: 'เบอร์ 8 สุรสิทธิ์ นิธิวุฒิวรรักษ์ ผู้สมัคร สส. ชลบุรี เขต 6 พรรคภูมิใจไทย | 8 กุมภาพันธ์ 2569',
                    url: 'https://surasit-landing.vercel.app'
                  };
                  ...
                  if (navigator.share) {
                    ...
                    window.open('https://www.facebook.com/sharer/sharer.php?u=https://surasit-landing.vercel.app', '_blank');
                  }
                }}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 rounded-full font-bold transition-all hover:scale-105"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
